        ...
        if (value != 'undefined') {
            ...
            jQuery.each(colorHex,function(colkey,hexval){
                if(colLegendKey.toLowerCase()==colkey.toLowerCase()){
                    ...
                    //legendHtml += '<tr><td><img src="'+home_url+'wp-content/plugins/digi-diss/assets/js/leaflet/images/marker-'+ key + '-icon.png" style="height:20px"> </td><td>' + value + '</td></tr>';
...
function addStoryModeToMap(digidissitems, map, markerCluster, customItems) {
    var items = digidissitems.concat(customItems);
    ...
    L.easyButton('fa-arrows-alt', function(btn, map){
        itemIndex = 0;
        fitToBounds(digidissitems, customItems, map);
    }, 'Reset').addTo(map);
}
...
function addCustomItemsToMap(items, markerCluster, home_url,colorHex) {
    ...
    jQuery.each(items, function(index, item) {
        ...
        var icon = L.icon({
            iconUrl: home_url + 'wp-content/plugins/digi-diss/assets/js/leaflet/images/marker-blue-icon.png',
            iconRetinalUrl: home_url + 'wp-content/plugins/digi-diss/assets/js/leaflet/images/marker-blue-icon-2x.png',
            iconSize: [29, 41],
            iconAnchor: [14, 41],
            popupAnchor: [0, -41],
            shadowUrl: home_url + 'wp-content/plugins/digi-diss/assets/js/leaflet/images/marker-shadow.png',
            shadowRetinaUrl: home_url + 'wp-content/plugins/digi-diss/assets/js/leaflet/images/marker-shadow.png',
            shadowSize: [41, 41],
            shadowAnchor: [13, 41]
        });
        jQuery.each(colorGroups,function(key,value){
