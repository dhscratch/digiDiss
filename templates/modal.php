 ...
 */
?>
<script type="text/html" id='tmpl-digidiss-modal-window'>
	<div class="backbone_modal">
		...
		<div class="backbone_modal-content">
			...
			<section class="backbone_modal-main" role="main">
				<header><h1><?php echo __( 'Add toy Shortcodes', 'backbone_modal' ); ?></h1></header>
				<article></article>
				<footer>
 ...
 */
?>
<script type="text/html" id='tmpl-digidiss-modal-backdrop'>
 ...
 */
?>
<script type="text/html" id='tmpl-digidiss-modal-menu-item'>
 ...
 */
?>
<script type="text/html" id='tmpl-digidiss-modal-menu-item-separator'>
...
*/
?>
<script type='text/html' id='tmpl-digidiss-modal-tab-content'>
	<div class="wrap">
		<h1 class="title">{{data.title}}</h1>
		<h2 class="nav-tab-wrapper">
			<a class="nav-tab nav-tab-active" href="#digidiss">digi-dissItems</a>
		...
		<div class="pane" id="digidiss">
			...
			<br/>
			<div class="digi-chosen"></div>
			<br/>
			<button class="digi-facets-button">Show Filtering Options</button>

			<!-- Code to add Select all checkbox only for map and timeline -->
			<# if(data.title == "Map" || data.title == "Timeline"){ #>
	      <label id="select-all-label">
	        <input id="digi-select-all-item" type="checkbox"> Select All </input>
	      </label>
      <# } #>

			<div class="digi-items">Loading...</div>
			<div class="digi-facets hidden">
				<b class="digi-facet-title">Filters <a href='' class="digi-close-facets"><span class="dashicons dashicons-no"> </span></a></b>
				<div class="digi-sort"><label for="digi-sort">Sort By: </label><select name="digi-sort"><option value="">Relevance</option><option value="title">Title</option><option value="creator">Creator</option><option value="date">Date Created</option></select></div>
				<div class="digi-date">
				</div>
				<div class="digi-subject">
				</div>
				<div class="digi-creator">
				</div>
				<div class="digi-type">
				</div>
			</div>
			<ol id="sortable-{{data.type}}-list" class="fullwidth"></ol><div class="digi-pagination"></div>
		</div>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-select'>
	<td>
		<label for='{{data.name}}'>
			{{data.label}}
		</label>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-checkbox'>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-number'>
	<td>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-text'>
	<td>
		<label for="{{data.name}}">{{data.label}}</label>
	</td>
	<td>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-button'>
	<td><h5>{{data.label}}</h5></td>
	<td>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-colorheader'>
...
?>
<script type='text/html' id='tmpl-digidiss-setting-colorinput'>
